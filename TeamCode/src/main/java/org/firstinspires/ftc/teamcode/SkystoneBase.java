...
public class SkystoneBase extends LinearOpMode {
    ...
    public void moveToLegos() throws InterruptedException {
        ...
        if (playSide==PlayfieldSide.Red) {
            AutonomousCommon.macanumMovementTimeBased(frontLeft, rearLeft, frontRight, rearRight, StrafeDirection.Right, 5, 0.6, opModeIsActive(), telemetry);
            AutonomousCommon.macanumMovementTimeBased(frontLeft, rearLeft, frontRight, rearRight, StrafeDirection.Forward, 25, 0.6, opModeIsActive(), telemetry);
        }
        if (playSide==PlayfieldSide.Blue) {
            AutonomousCommon.macanumMovementTimeBased(frontLeft,rearLeft,frontRight,rearRight,StrafeDirection.Left,5,0.6,opModeIsActive(),telemetry);
            AutonomousCommon.macanumMovementTimeBased(frontLeft, rearLeft, frontRight, rearRight, StrafeDirection.Forward, 25, 0.6, opModeIsActive(), telemetry);
    ...
    public void moveToScanPosition() throws InterruptedException {
        ...
        if (playSide==PlayfieldSide.Red) {
            //AutonomousCommon.macanumMovementTimeBased(frontLeft, rearLeft, frontRight, rearRight, StrafeDirection.Right, 5, 0.6, opModeIsActive(), telemetry);
            AutonomousCommon.macanumMovementTimeBased(frontLeft, rearLeft, frontRight, rearRight, StrafeDirection.Forward, 13, 0.6, opModeIsActive(), telemetry);
        }
        if (playSide==PlayfieldSide.Blue) {
            //AutonomousCommon.macanumMovementTimeBased(frontLeft,rearLeft,frontRight,rearRight,StrafeDirection.Left,5,0.6,opModeIsActive(),telemetry);
            AutonomousCommon.macanumMovementTimeBased(frontLeft, rearLeft, frontRight, rearRight, StrafeDirection.Forward, 13, 0.6, opModeIsActive(), telemetry);
    ...
    public void moveToLegosFromScanPosition() throws InterruptedException {
        ...
        if (playSide==PlayfieldSide.Red) {
            //AutonomousCommon.macanumMovementTimeBased(frontLeft, rearLeft, frontRight, rearRight, StrafeDirection.Right, 5, 0.6, opModeIsActive(), telemetry);
            AutonomousCommon.macanumMovementTimeBased(frontLeft, rearLeft, frontRight, rearRight, StrafeDirection.Forward, 12, 0.6, opModeIsActive(), telemetry);
        }
        if (playSide==PlayfieldSide.Blue) {
            //AutonomousCommon.macanumMovementTimeBased(frontLeft,rearLeft,frontRight,rearRight,StrafeDirection.Left,5,0.6,opModeIsActive(),telemetry);
            AutonomousCommon.macanumMovementTimeBased(frontLeft, rearLeft, frontRight, rearRight, StrafeDirection.Forward, 12, 0.6, opModeIsActive(), telemetry);
    ...
    public void moveToBuildingZone() throws InterruptedException{
        ...
        if(playSide==PlayfieldSide.Blue){
            clawServo.setPower(-1.0);
            AutonomousCommon.macanumMovementTimeBased(frontLeft,rearLeft,frontRight,rearRight,StrafeDirection.Backward,15,0.6,opModeIsActive(),telemetry);
            AutonomousCommon.macanumRotate(frontLeft,rearLeft,frontRight,rearRight,90,opModeIsActive(),telemetry,RotateDegree.Positive);
            AutonomousCommon.macanumMovementTimeBased(frontLeft,rearLeft,frontRight,rearRight,StrafeDirection.Forward,60,0.6,opModeIsActive(),telemetry);
        }
        if(playSide==PlayfieldSide.Red){
            clawServo.setPower(-1.0);
            AutonomousCommon.macanumMovementTimeBased(frontLeft,rearLeft,frontRight,rearRight,StrafeDirection.Backward,15,0.6,opModeIsActive(),telemetry);
            AutonomousCommon.macanumRotate(frontLeft,rearLeft,frontRight,rearRight,90,opModeIsActive(),telemetry,RotateDegree.Negative);
            AutonomousCommon.macanumMovementTimeBased(frontLeft,rearLeft,frontRight,rearRight,StrafeDirection.Forward,125,0.6,opModeIsActive(),telemetry);
        }
